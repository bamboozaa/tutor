			...
			<div class="panel-body">
	    		...
	    		<div class="row" style="margin-top:20px; margin-bottom:100px">
	        		...
	        		<div class="col-md-4 col-sm-6" align="center">
		            	<!--login form-->
		            	<h5 style="color:#800000">* ใช้ <u>เลขประจำตัวประชาชน</u> หรือ
						<u>หมายเลขโทรศัพท์</u> ที่ลงทะเบียนไว้ อย่างใดอย่างหนึ่งในการตรวจสอบข้อมูล*</h4>
		            	<form data-toggle="validator" role="form" name="loginForm" action="checkregister_detail.php" Method="Post">
	                	<div class="form-group" style="margin-top:20px">
		                    <div class="input-group">
		                        <div class="input-group-addon"><span class="glyphicon glyphicon-user" aria-hidden="true"></span></div>
		                        <input type="text" name="username" id="username" class="form-control" autocomplete="off"  placeholder="เลขประจำตัวประชาชน" style="font-size:12pt">
		                    </div>
	                	</div>
		                <div class="form-group">
		                    <div class="input-group ">
		                        <div class="input-group-addon"><span class="glyphicon glyphicon-phone" aria-hidden="true"></span></div>
		                        <input type="text" name="password" id = "password" class="form-control" autocomplete="off" placeholder="เบอร์โทรศัพท์" style="font-size:12pt">
		                    </div>
		                </div>	                	           
		                <div class="form-group" style="margin-top:10px">
		                    <input type="submit" value="ตรวจสอบข้อมูล" name="login_button" class="btn btn-primary btn-block login-button" id="login_button" style="font-size:12pt">
		                </div>
	        			</form>	
	        		</div>
	        		<div class="col-md-4 col-sm-3" align="center"></div>	                
