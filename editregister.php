...
<?php
	...
	$idcard = substr($stu_idcard,0,9)."****";		
	
	if (($chk_out1) or ($chk_out2)) {	
?>
			...
			<div class="panel-body">
				...
				<div class="col-sm-6">
					...
					<div class="form-group" style="padding: 5px;">
						...
						<?php if ($stu_idcard) { ?> 	
							<input type="text" class="form-control" value="<?php echo $idcard?>" style="font-size:15px;" disabled><div class="col-sm-12 space"></div>
						<?php } else { ?>
						<div class="input-group" data-validate="idcard">
							<input type="text" class="form-control" name="idcard" id="validate-idcard" value="<?php echo $stu_idcard?>" style="font-size: 15px;" required>
							<span class="input-group-addon danger"><span class="glyphicon glyphicon-remove"></span></span>
						</div><div class="col-sm-12 space"></div>	
						<?php } ?>						
						<input type="text" class="form-control" name="nickname" placeholder="ชื่อเล่น" value="<?php echo $stu_nickname?>" style="font-size:15px;"><div class="col-sm-12 space"></div>
				...
				<div class="col-sm-6">			
					...
					<div class="form-group" style="padding: 5px;">
						...
						<input type="text" class="form-control" value="<?php echo $stu_station?>" style="font-size:15px;" disabled><div class="col-sm-12 space"></div>												
					</div>		
				</div>
